...
اهلا بك ! {}
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
✘ انا بوت الماس لحماية مجموعتك وتشغيل المقاطع الصوتية في المكالمه**.
...
async def start(event):
    ...
    if event.is_private:
       await event.client.send_file(event.chat_id,
        ...
        [Button.url("المطور", "https://t.me/BK_ZT")],
        [Button.url("جروب الدعم", f"https://t.me/{Config.SUPPORT}"), Button.url("قناة السورس", f"https://t.me/{Config.CHANNEL}")],
